    ...
    xhr.onload = function(e) {
        if (this.readyState === 4) {
            ...
            console.log(response);
             el('myResult').innerHTML = response.result;
            if(response.result == 'samosa')
            {
              el('linkedPage').innerHTML = 'https://swaggy-ka-swag.onrender.com/samosa';
            }
            else
            {
              el('linkedPage').innerHTML = 'One of the 17 other classes';
            }
        }
